export const profile_content = {
  hero: {
    ...
    primary_cta: {
      ...
      href: "https://drive.google.com/file/d/1pxjR2ygjHImHPSqF4Az5OpiyFPs4LoBD/view?usp=sharing",
      target: "_blank",
    },
    secondary_cta: {
  ...
  skills: [
    {
      ...
      items: [
        ...
        { icon: "nestjs", label: "NestJS & Node.js (Express, Fastify, Koa)" },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: "rabbitmq", label: "RabbitMQ" },
        { icon: "influxdb", label: "InfluxDB" },
    ...
    },
    {
      ...
      items: [
        { icon: "cicd", label: "CI/CD Automation" },
        { icon: "testing", label: "Unit, Integration, And E2E Testing" },
        { icon: "load_testing", label: "K6 Load Testing" },
        { icon: "design_patterns", label: "Design Patterns" },
      ],
    },
  ],
  projects: [
